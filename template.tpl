...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "trbo Basket Conversion",
  ...
  "description": "Dieses Tag soll immer dann (und nur dann) gefeuert werden, wenn ein Produkt über den Warenkorb-Button in den Warenkorb gelegt wird. Dazu müssen Sie ggf. ein neues Event erstellen (lassen).",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "value",
    "displayName": "Wert des Warenkorbs",
    "simpleValueType": true,
    "help": "Der Wert des Warenkorbs als Float",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Hinzugefügte Produktobjekte in einem Array: [ \t\t\t{ \t\t\tproduct_id: {{addedProductId}}, \t\t\tname: {{addedProductName}}, \t\t\tquantity: {{addedProductQuantity}}, \t\t\tprice: {{addedProductPrice}} \t\t\t} \t\t]",
    "valueHint": "{{addedProducts}}",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
